...
EXECUTE_ON_STARTUP(
    ...
    e->insert(IB_TIMER_MSG, "IB_TIMER_MSG");
    e->insert(IB_PUSHFECN_MSG, "IB_PUSHFECN_MSG");
    e->insert(IB_PUSHBECN_MSG, "IB_PUSHBECN_MSG");
    e->insert(IB_CCTIMER_MSG, "IB_CCTIMER_MSG");
    e->insert(IB_SENDTIMER_MSG, "IB_SENDTIMER_MSG");
    e->insert(IB_SINKTIMER_MSG, "IB_SINKTIMER_MSG");
)
...
int IBDataMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "isFECN")==0) return base+16;
    if (fieldName[0]=='i' && strcmp(fieldName, "isBECN")==0) return base+17;
    if (fieldName[0]=='R' && strcmp(fieldName, "RecvRate")==0) return base+18;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string IBDataMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 16: return long2string(pp->getIsFECN());
        case 17: return long2string(pp->getIsBECN());
        case 18: return double2string(pp->getRecvRate());
        default: return "";
    }
}
...
bool IBDataMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 16: pp->setIsFECN(string2long(value)); return true;
        case 17: pp->setIsBECN(string2long(value)); return true;
        case 18: pp->setRecvRate(string2double(value)); return true;
        default: return false;
    }
}
...
IBSinkTimerMsgDescriptor::IBSinkTimerMsgDescriptor() : omnetpp::cClassDescriptor("IBSinkTimerMsg", "omnetpp::cMessage")
{
    propertynames = nullptr;
}
...
int IBSinkTimerMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IBSinkTimerMsg *pp = (IBSinkTimerMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *IBSinkTimerMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IBSinkTimerMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool IBSinkTimerMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *IBSinkTimerMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
IBPushFECNMsgDescriptor::IBPushFECNMsgDescriptor() : omnetpp::cClassDescriptor("IBPushFECNMsg", "omnetpp::cMessage")
{
    propertynames = nullptr;
}
...
int IBPushFECNMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "msgIdx")==0) return base+3;
    if (fieldName[0]=='a' && strcmp(fieldName, "appIdx")==0) return base+4;
    if (fieldName[0]=='R' && strcmp(fieldName, "RecvRate")==0) return base+5;
    if (fieldName[0]=='B' && strcmp(fieldName, "BECNValue")==0) return base+6;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
int IBPushFECNMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IBPushFECNMsg *pp = (IBPushFECNMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *IBPushFECNMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IBPushFECNMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getMsgIdx());
        case 4: return long2string(pp->getAppIdx());
        case 5: return double2string(pp->getRecvRate());
        case 6: return long2string(pp->getBECNValue());
        default: return "";
    }
}

bool IBPushFECNMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 3: pp->setMsgIdx(string2long(value)); return true;
        case 4: pp->setAppIdx(string2long(value)); return true;
        case 5: pp->setRecvRate(string2double(value)); return true;
        case 6: pp->setBECNValue(string2long(value)); return true;
        default: return false;
    }
}
...
void *IBPushFECNMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
IBPushBECNMsgDescriptor::IBPushBECNMsgDescriptor() : omnetpp::cClassDescriptor("IBPushBECNMsg", "IBWireMsg")
{
    propertynames = nullptr;
}
...
int IBPushBECNMsgDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0]=='B' && strcmp(fieldName, "BECNValue")==0) return base+0;
    if (fieldName[0]=='s' && strcmp(fieldName, "srcLid")==0) return base+1;
    if (fieldName[0]=='d' && strcmp(fieldName, "dstLid")==0) return base+2;
    if (fieldName[0]=='S' && strcmp(fieldName, "SL")==0) return base+3;
    if (fieldName[0]=='m' && strcmp(fieldName, "msgIdx")==0) return base+4;
    if (fieldName[0]=='a' && strcmp(fieldName, "appIdx")==0) return base+5;
    if (fieldName[0]=='R' && strcmp(fieldName, "RecvRate")==0) return base+6;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
int IBPushBECNMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IBPushBECNMsg *pp = (IBPushBECNMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *IBPushBECNMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IBPushBECNMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IBPushBECNMsg *pp = (IBPushBECNMsg *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getBECNValue());
        case 1: return long2string(pp->getSrcLid());
        case 2: return long2string(pp->getDstLid());
        case 3: return long2string(pp->getSL());
        case 4: return long2string(pp->getMsgIdx());
        case 5: return long2string(pp->getAppIdx());
        case 6: return double2string(pp->getRecvRate());
        default: return "";
    }
}

bool IBPushBECNMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IBPushBECNMsg *pp = (IBPushBECNMsg *)object; (void)pp;
    switch (field) {
        case 0: pp->setBECNValue(string2long(value)); return true;
        case 1: pp->setSrcLid(string2long(value)); return true;
        case 2: pp->setDstLid(string2long(value)); return true;
        case 3: pp->setSL(string2long(value)); return true;
        case 4: pp->setMsgIdx(string2long(value)); return true;
        case 5: pp->setAppIdx(string2long(value)); return true;
        case 6: pp->setRecvRate(string2double(value)); return true;
        default: return false;
    }
}
...
void *IBPushBECNMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
